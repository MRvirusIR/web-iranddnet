(function ($) {
  ...
  if ($("#about-page")[0]) {
    ...
    $(window).scroll(function () {
      ...
      let $animation_elements = $(
        ".se-i .random-icons img,.se-i .random-icons-right img"
      );
      if (scroll > position) {
  ...
  $("#filter-nav-v .tab").on("click", function () {
    ...
    $('#compare-table-v tbody tr[data-filter="' + val + '"]').removeClass(
      "tr-hide"
    );
  });
  ...
  $("#custom-thead-v .tab").on("click", function () {
    ...
    $('#compare-table-v tbody tr td[data-for="' + val + '"]').removeClass(
      "td-hide"
    );
    // Content
    $("#custom-thead-v .tab-content[data-for]").addClass("content-hide");
    $('#custom-thead-v .tab-content[data-for="' + val + '"]').removeClass(
      "content-hide"
    );
  });
  // --------------------------------
